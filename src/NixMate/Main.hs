module NixMate.Main where

import Data.Coerce
import Data.Foldable (traverse_)
import Data.Maybe (fromMaybe)
import qualified NixMate.Actions.Add as Actions
import qualified NixMate.Actions.Config as Actions
import qualified NixMate.Actions.CreateNixFile as Actions
import qualified NixMate.Actions.Direnv as Actions
import qualified NixMate.Actions.Docker as Actions
import qualified NixMate.Actions.Pin as Actions
import qualified NixMate.Actions.Remove as Actions
import qualified NixMate.Actions.Search as Actions
import qualified NixMate.Actions.Shell as Actions
import qualified NixMate.Actions.Tags as Actions
import NixMate.Options
  ...
  case cmd of
    ...
    Docker -> do
      ...
      case cfg of
        Left CouldNotLoadConfig ->
          print "No nix-mate.json found in this folder"
        Right cfg' -> Actions.doDocker cfg'
